...
<Text style={styles.headerText}> Search for your movie:</Text>
...
/>
 <MagnifyingGlass color="#FFFFFF" size={25} weight="light" />
  </View>
  </View> 
 ...
 {loading && <ActivityIndicator size={50} color="#24db04"/>}
  </View>
  </View>
 );
}